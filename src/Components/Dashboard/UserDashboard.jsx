...
const UserDashboard = () => {
  ...
  const track = () => {
    navigate("/dashboard/track-parcel");
  };
  return (
    <div className="p-6 space-y-8">
      <div className="relative h-48 rounded-xl overflow-hidden shadow">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
          <h2 className="text-white text-3xl text-center font-bold">
            Welcome Back! Your Parcels Are on the Move
          </h2>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-blue-100 rounded-xl p-6 shadow text-center">
          ...
          <button className="btn btn-primary btn-sm mt-4" onClick={create}>
            Create Now
          </button>
        </div>
        ...
        <div className="bg-green-100 rounded-xl p-6 shadow text-center">
          ...
          <p className="text-gray-700">
            Stay updated with real-time parcel tracking.
          </p>
          <button className="btn btn-success btn-sm mt-4" onClick={track}>
            Track Parcels
          </button>
        </div>
      </div>
